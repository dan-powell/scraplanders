                ...
                <div class="box box-default">
                    ...
                    <div class="box-footer no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li>
                                <a href="#">
                                    India <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                    ...
                    <div class="box-body">
                        <ul class="products-list product-list-in-box">
                            ...
                            <li class="item">
                                ...
                                <div class="product-info">
                                    <a href="javascript:void(0)" class="product-title">Xbox One <span class="label label-danger pull-right">$350</span>
                                    </a>
                                    <span class="product-description">
